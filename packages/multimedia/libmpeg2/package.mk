...
# NOTE(w2xg2022): libmpeg2.sourceforge.net回404，改用repo內自帶鏡像(源碼取自
# VM本地sources/快取，sha256驗證跟本檔案記錄的完全一致，正版原始檔案)。
PKG_URL="https://raw.githubusercontent.com/w2xg2022/EmuELEC/main/packages/multimedia/libmpeg2/${PKG_NAME}-${PKG_VERSION}.tar.gz"
